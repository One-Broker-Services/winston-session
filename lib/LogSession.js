...
class LogSession {
  constructor(opt = {}) {
    ...
    this._segment = null;
    this._defaultLoggerId = 'DEFAULT_LOGGER';
    this._sessionLoggerId = this._defaultLoggerId;
    this._group = null;
    this._label = null;
    ...
    this._defaultLogger = this._service.addLogger(this._defaultLoggerId);
  }
  ...
  // set logger(id) {
  //   this._defaultLogger = this._service.logger(id);
  //   return this;
  // }
  ...
  globalConfig(options) {
    this._defaultLogger = this._service.configLogger(this._defaultLoggerId, options);
  }
